...
function draw() {
  ...
  context.fillStyle = snakeColor;
	context.fillRect(snakePosX, snakePosY, snakeWidth, snakeHeight);
	//draw food
...
function newFood() {
	//TODO: place the food at a random x and y coordinate
	//HINT: Math.random() will generate a random number between 0 and 1 (5)
	foodPosX = 100; 
	foodPosY = 100;
}
